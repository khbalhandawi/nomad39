...
namespace NOMAD {
    ...
    class DLL_API Signature {
        ...
        /**
         ...
         \param anisotropic_mesh            Anisotropy of mesh (XMesh,GMesh) -- \b IN.
         \param anisotropy_factor           Anisotropy factor of the mesh (GMesh only) -- \b IN.
         \param granularity                 Granularity                 -- \b IN.
        ...
        /**
         ...
         \param int_poll_dir_types Types of directions for intensification poll -- \b IN.
         \param out                Display                                -- \b IN.
         */
        Signature ( int                                       n                 ,
                   const std::vector<NOMAD::bb_input_type> & input_types        ,
        ...
        /**
         ...
         \param poll              Type of poll (primary, secondary or intensification)     -- \b IN.
